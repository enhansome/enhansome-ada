...
* [spark-by-example](https://github.com/tofgarion/spark-by-example) ⭐ 165 | 🐛 2 | 🌐 Ada | 📅 2022-08-16 - Collection of verified functions and data types in SPARK.
...
* [ada-composition](https://github.com/gerr135/ada_composition) ⭐ 10 | 🐛 0 | 🌐 Ada | 📅 2019-11-25 - A collections of small nifty demos/sample code that may help better layout data or structure project.
...
* [adalib](https://github.com/reznikmm/adalib) ⭐ 24 | 🐛 2 | 🌐 Ada | 📅 2021-08-29 - Standard Ada library specification as defined in Reference Manual.
* [Ada 2022 Reference Card](https://github.com/bracke/AdaReferenceCard/releases) ⭐ 15 | 🐛 9 | 🌐 TeX | 📅 2024-07-14 - Reference Card / Cheatsheet of Ada Attributes, Aspects, Pragmas and Standard Library.
...
* [crate-of-the-year](https://github.com/AdaCore/Ada-SPARK-Crate-Of-The-Year) ⭐ 25 | 🐛 0 | 📅 2025-11-18 - Yearly prize for the best Alire crate in three categories: general, SPARK and embedded.
...
* [fsf-gnat](https://github.com/alire-project/GNAT-FSF-builds/releases) ⭐ 59 | 🐛 6 | 🌐 Python | 📅 2026-08-11 - Free Software Foundation compiler for the Ada programming language which forms part of the GNU Compiler Collection. It supports all versions of the language, i.e. Ada 2022, Ada 2012, Ada 2005, Ada 95 and Ada 83.

#### MIT

* [hac](https://github.com/zertovitch/hac) ⭐ 174 | 🐛 8 | 🌐 Ada | 📅 2026-08-13 - The HAC Ada Compiler - a small, quick Ada compiler fully in Ada.
...
* [augusta](https://github.com/pchapin/augusta) ⭐ 32 | 🐛 3 | 🌐 Scala | 📅 2025-05-05 - Ada compiler written in Scala that targets LLVM.
...
* [gnat-ce (discontinued)](https://github.com/AdaCore/gnat-community-archives) ⭐ 3 | 🐛 0 | 🌐 Python | 📅 2025-07-04 - GNAT Community edition. A release of AdaCore GNAT for free software developers, hobbyists, and students. The run-time libraries provided with GNAT Community are licensed under GPLv3 without linking exception. It supports Ada 2012 only.

## Edit

### Integrated Development Editors

<img width="120px" hspace="10px" src="https://docs.adacore.com/live/wave/gps/html/gps_ug/_images/gps-main-window.png"/> [The GNAT Programming Studio](https://github.com/AdaCore/gps) ⭐ 524 | 🐛 57 | 🌐 Ada | 📅 2026-08-12
...
* [doom-ada](https://github.com/tomekw/doom-ada) ⭐ 19 | 🐛 1 | 🌐 Emacs Lisp | 📅 2025-09-15 - Doom Emacs Ada language module with syntax highlighting, LSP and Alire support.
* [ob-ada-spark](https://github.com/rocher/ob-ada-spark/) ⭐ 9 | 🐛 1 | 🌐 Emacs Lisp | 📅 2022-11-14 - Ada/SPARK support for org-babel : Evaluate source code blocks with Gnu Emacs and org files.
* [vim-ada-bundle](https://github.com/thindil/Ada-Bundle) ⭐ 8 | 🐛 0 | 🌐 Vim script | 📅 2021-01-28 - Maintained Ada Bundle : Complete Ada-Mode for Vim/Neovim.
* [ada-tmbundle](https://github.com/textmate/ada.tmbundle) ⭐ 6 | 🐛 2 | 📅 2015-04-27 - TextMate support for Ada.
...
* [ada-vscode](https://github.com/Lucretia/ada-vscode) ⭐ 1 | 🐛 1 | 📅 2019-07-24 - Basic syntax highlighting for Ada and GPR.
* [ada-utilities](https://github.com/Lucretia/ada-utilities) ⭐ 0 | 🐛 2 | 🌐 TypeScript | 📅 2023-03-03 - VSCode extension Ada programmers which provides a few utility functions.
...
* [alire](https://github.com/alire-project/alire) ⭐ 408 | 🐛 360 | 🌐 Ada | 📅 2026-08-03 - A catalog of ready-to-use Ada libraries plus a command-line tool (alr) to obtain, compile, and incorporate them into your own projects. It aims to fulfill a similar role to Rust's cargo or OCaml's opam.
* [synth](https://github.com/jrmarino/synth) ⭐ 271 | 🐛 13 | 🌐 Ada | 📅 2026-06-26 - Next D/Ports build tool for live systems (Alternative for Portmaster and Portupgrade tools).
* [gprbuild](https://github.com/AdaCore/gprbuild) ⭐ 80 | 🐛 40 | 🌐 Ada | 📅 2026-07-29 - Adacore multi-language software build tool.
...
* [ravenadm](https://github.com/jrmarino/ravenadm) ⭐ 22 | 🐛 14 | 🌐 Ada | 📅 2026-05-15 - Administration tool for Ravenports <http://www.ravenports.com>.
...
* [cmake-ada-offa](https://github.com/offa/cmake-ada) ⭐ 13 | 🐛 1 | 📅 2014-11-12 - Ada language support for CMake.
* [ada4cmake](https://github.com/mosteo/ada4cmake) ⭐ 5 | 🐛 0 | 🌐 CMake | 📅 2020-09-14 - CMake macros for simple gnat project inclusion.
* [cmake-ada-cho3](https://github.com/cho3/cmake-ada) ⭐ 1 | 🐛 0 | 🌐 CMake | 📅 2018-10-13 - CMake language support for Ada, fork of [plplot]'s cross-platform support code.

### Continuous Integration

* [ada-actions](https://github.com/ada-actions/toolchain) ⭐ 24 | 🐛 4 | 🌐 JavaScript | 📅 2022-03-11 - Ada Toolchains for GitHub Actions.
* [continuous-verification](https://github.com/jklmnn/continuous-verification) ⭐ 8 | 🐛 0 | 🌐 Ada | 📅 2019-06-08 - SPARK formal verification automated with Travis CI.
...
* [adawebpack](https://github.com/godunko/adawebpack) ⭐ 81 | 🐛 4 | 🌐 Ada | 📅 2025-02-16 - GNAT RTL for WebAssembly and bindings for Web API.
* [cortex-gnat-rts](https://github.com/simonjwright/cortex-gnat-rts) ⭐ 79 | 🐛 7 | 🌐 Ada | 📅 2025-03-18 - This package includes GNAT Ada Run Time Systems (RTSs) based on FreeRTOS and targeted at boards with Cortex-M0, M3, -M4, -M4F MCUs.
* [bb-runtimes](https://github.com/AdaCore/bb-runtimes) ⭐ 71 | 🐛 6 | 🌐 Ada | 📅 2026-07-30 - GNAT bare metal board support package (BSP).
...
* [bare-bones](https://github.com/Lucretia/bare_bones) ⭐ 91 | 🐛 0 | 🌐 Ada | 📅 2016-11-20 - An Ada port of the [osdev.org](https://wiki.osdev.org/Ada_Bare_Bones) minimal 32-bit x86 kernel.
* [cubit](https://github.com/docandrew/CuBit) ⭐ 89 | 🐛 4 | 🌐 Ada | 📅 2026-05-22 - CuBitOS is a multi-processor, 64-bit, (partially) formally-verified, general-purpose operating system, currently for the x86-64 architecture.
...
* [Straylight](https://github.com/ajxs/straylight) ⭐ 3 | 🐛 0 | 🌐 Ada | 📅 2026-08-09 - A simple monolithic RISC-V operating system developed in Ada.
...
* [eepers](https://github.com/tsoding/eepers) ⭐ 470 | 🐛 5 | 🌐 Ada | 📅 2024-05-26 - A simple Turn-based Game in Ada (made with [raylib](https://github.com/raysan5/raylib) ⭐ 34,320 | 🐛 30 | 🌐 C | 📅 2026-08-13).
* [steamsky](https://github.com/thindil/steamsky) ⭐ 104 | 🐛 1 | 🌐 Nim | 📅 2026-08-14 - Roguelike in sky with a steampunk setting.
* [gade](https://github.com/ellamosi/gade) ⭐ 32 | 🐛 14 | 🌐 Ada | 📅 2026-04-11 - A Game Boy emulation library in Ada.
* [ada-gate](https://github.com/fastrgv/AdaGate) ⭐ 25 | 🐛 0 | 🌐 Ada | 📅 2026-05-05 - AdaGate is a first-person 3D sokoban puzzle game within a Stargate / Portal fantasy setting for Windows, OS-X and Linux.
* [civ-klon](https://github.com/HonkiTonk/Civ-Klon) ⭐ 23 | 🐛 1 | 🌐 Ada | 📅 2026-07-30 - Civilization-style turn-based strategy game. Requires [asfml].
* [ada-venture](https://github.com/fastrgv/AdaVenture) ⭐ 18 | 🐛 0 | 🌐 Ada | 📅 2026-05-05 - AdaVenture is a kid-friendly retro point\&click game with mazes, dragons, bats & snakes.
...
* [retro-arcade](https://github.com/fastrgv/RetroArcade) ⭐ 6 | 🐛 1 | 🌐 Ada | 📅 2024-09-15 - Space Invaders, Pacman, & Frogger games that run in a terminal on Windows, OS-X & Linux.
...
* [gnatcoll-bindings](https://github.com/AdaCore/gnatcoll-bindings) ⭐ 15 | 🐛 6 | 🌐 Ada | 📅 2026-02-11 - This is the bindings module of the GNAT Components Collection.
* [gnatcoll-db](https://github.com/AdaCore/gnatcoll-db) ⭐ 14 | 🐛 47 | 🌐 C | 📅 2025-11-28 - This is the DB module of the GNAT Components Collection.
* [lace](https://github.com/charlie5/lace) ⭐ 12 | 🐛 1 | 🌐 Ada | 📅 2026-08-02 - A set of Ada components to allow 3D simulations, games and GUI's in Ada.
...
* [poly-orb](https://github.com/AdaCore/PolyORB) ⭐ 24 | 🐛 4 | 🌐 Ada | 📅 2026-06-26 - PolyORB provides a uniform solution to build distributed applications relying either on middleware standards.

### Graphical User Interface

* [gtkada](https://github.com/AdaCore/gtkada) ⭐ 109 | 🐛 31 | 🌐 Ada | 📅 2026-08-14 - Ada graphical toolkit based on Gtk3 components.
...
* [gwindows](https://github.com/zertovitch/gwindows) ⭐ 26 | 🐛 3 | 🌐 Ada | 📅 2026-07-10 - GNU Ada Visual Interface.
...
* [ada-doom-3](https://github.com/AdaDoom3/AdaDoom3) ⭐ 287 | 🐛 8 | 🌐 Ada | 📅 2023-03-29 - Id Software's Id-tech-4-BFG in the Ada programming language.
* [globe-3d](https://github.com/zertovitch/globe-3d) ⭐ 21 | 🐛 0 | 🌐 Ada | 📅 2026-06-04 - GL Object Based Engine for 3D.
* [ada-ogl](https://github.com/JulianSchutsch/AdaOGL) ⭐ 5 | 🐛 0 | 🌐 Ada | 📅 2015-12-23 - Ada OpenGL Framework.
* [engine-3d](https://github.com/zertovitch/engine-3d) ⭐ 4 | 🐛 0 | 🌐 Ada | 📅 2026-01-23 - A 3D engine for DOS-talgics.
...
* [aws](https://github.com/AdaCore/aws) ⭐ 159 | 🐛 41 | 🌐 Ada | 📅 2026-08-04 - Ada Web Server is a complete framework to develop Web based applications in Ada.

<!--lint enable awesome-list-item-->

* [awa](https://github.com/stcarrez/ada-awa) ⭐ 112 | 🐛 13 | 🌐 Ada | 📅 2026-08-09 - Ada Web Application is a framework to build a Web Application in Ada 2012. The framework provides several ready to use and extendable modules that are common to many web application. This includes the login, authentication, users, permissions, managing comments, tags, votes, documents, images.
  * [ada-security](https://github.com/stcarrez/ada-security) ⭐ 23 | 🐛 2 | 🌐 Ada | 📅 2026-08-09 - OAuth 2.0 client and server framework to secure web applications.
  * [ada-wiki](https://github.com/stcarrez/ada-wiki) ⭐ 20 | 🐛 4 | 🌐 Ada | 📅 2026-07-14 - Ada Wiki is a small library that provides a Wiki engine.
  * [dynamo](https://github.com/stcarrez/dynamo) ⭐ 18 | 🐛 5 | 🌐 Ada | 📅 2026-04-04 - Code generator used to generate an Ada Web Application or database mappings from hibernate-like XML description, YAML doctrine model or UML models.
  * [ada-asf](https://github.com/stcarrez/ada-asf) ⭐ 15 | 🐛 4 | 🌐 JavaScript | 📅 2026-07-03 - Ada Server Faces allows to create web applications using the same pattern as the Java Server Faces (See JSR 252, JSR 314 and JSR 344).
  * [ada-servlet](https://github.com/stcarrez/ada-servlet) ⭐ 9 | 🐛 2 | 🌐 Ada | 📅 2026-06-27 - Ada Servlet allows to create web applications using the same pattern as the Java Servlet (See JSR 154, JSR 315).
...
* [matreshka](https://github.com/godunko/matreshka) ⭐ 14 | 🐛 3 | 🌐 Ada | 📅 2026-05-03 - Framework to develop information systems consisting of five major components: League, XML processor, Web framework, SQL access, and the Modeling framework.

[matreshka]: https://github.com/godunko/matreshka

### Unit Test, Testing

* [bbt](https://github.com/LionelDraghi/bbt) ⭐ 28 | 🐛 4 | 🌐 Ada | 📅 2026-07-24 - Simple tool to black box check the behavior of an executable through the command line.
* [aunit](https://github.com/AdaCore/aunit) ⭐ 12 | 🐛 13 | 🌐 Ada | 📅 2026-07-02 - Ada unit testing framework.
...
* [elogs](https://github.com/kevlar700/elogs) ⭐ 0 | 🐛 0 | 🌐 Ada | 📅 2026-04-10 - Logging framework for embedded systems absent of runtime errors.
...
* [septum](https://github.com/pyjarrett/septum) ⭐ 461 | 🐛 13 | 🌐 Ada | 📅 2026-08-14 - An interactive context-based text search tool for searching large codebases.
* [powerjoular](https://github.com/joular/powerjoular) ⭐ 115 | 🐛 10 | 🌐 Ada | 📅 2026-02-13 - This tool allows monitoring power consumption of multiple platforms and processes.
...
* [spark-2014](https://github.com/AdaCore/spark2014/) ⭐ 322 | 🐛 4 | 🌐 Ada | 📅 2026-08-14 - SPARK formal verification toolset.
* [gnat-coverage](https://github.com/AdaCore/gnatcoverage) ⭐ 46 | 🐛 3 | 🌐 Ada | 📅 2026-08-11 - GNATcoverage is a tool to analyze and report program coverage.
...
* [record-flux](https://github.com/Componolit/RecordFlux) ⭐ 129 | 🐛 186 | 🌐 Ada | 📅 2026-01-07 - RecordFlux: Toolset for the formal specification of messages and the generation of verifiable binary parsers and message generators in SPARK.
...
* [automate](https://github.com/Blady-Com/Automate) ⭐ 8 | 🐛 0 | 🌐 Ada | 📅 2023-11-02 - Finite-state machine generator.
...
* [ada-ml](https://github.com/rocher/AdaML) ⭐ 12 | 🐛 0 | 📅 2023-05-14 - Ada-tailored UML Modeling Language.
* [coldframe](https://github.com/simonjwright/coldframe) ⭐ 10 | 🐛 7 | 🌐 Ada | 📅 2023-10-04 - This tool generates Ada framework code and documentation from UML models.
...
* [ada-keystore](https://github.com/stcarrez/ada-keystore) ⭐ 37 | 🐛 3 | 🌐 Ada | 📅 2026-08-09 - Ada Keystore - protect your sensitive data with secure storage.

## Libraries

### Math

* [math-packages](https://github.com/jscparker/math_packages) ⭐ 28 | 🐛 0 | 🌐 Ada | 📅 2022-10-31 - Collection of basic math routines in Ada.
* [mathpaqs](https://github.com/zertovitch/mathpaqs) ⭐ 15 | 🐛 0 | 🌐 Ada | 📅 2026-06-04 - Collection of mathematical, 100% portable, packages in the Ada programming language.
* [geo-energy-math](https://github.com/pukpr/GeoEnergyMath) ⭐ 8 | 🐛 2 | 🌐 Ada | 📅 2026-06-10 - Software libraries for solving models described in Mathematical GeoEnergy (Wiley, 2018).
* [lalg](https://github.com/jhumphry/LALG) ⭐ 5 | 🐛 0 | 🌐 Ada | 📅 2022-04-11 - Interface to dense linear algebra packages.
* [mandelbrot-ascii](https://github.com/mosteo/mandelbrot_ascii) ⭐ 2 | 🐛 0 | 🌐 Ada | 📅 2019-10-27 - Mandelbrot renderer in "ASCII" (unicode actually, but text nonetheless).
* [hungarian](https://github.com/mosteo/hungarian) ⭐ 2 | 🐛 0 | 🌐 Ada | 📅 2018-06-10 - Ada binding to the fast Stachniss' Hungarian solver.
...
* [si](https://github.com/CKWG/SI_Units-Checked-and-Unchecked) ⭐ 4 | 🐛 0 | 🌐 Ada | 📅 2026-08-09 - Checked and unchecked SI units.
...
* [ada-language-server](https://github.com/AdaCore/ada_language_server) ⭐ 301 | 🐛 33 | 🌐 Ada | 📅 2026-08-12 - Adacore server implemention of the the Microsoft Language Protocol for Ada and SPARK.
...
* [hungarian-algorithm](https://github.com/fastrgv/HungarianAlgorithm) ⭐ 2 | 🐛 0 | 🌐 Ada | 📅 2025-12-06 - Hungarian Algorithm implementation in Ada.
* [ada-lsp-client](https://github.com/Alex-Gamper/Ada-LanguageServer) ⭐ 1 | 🐛 0 | 🌐 C# | 📅 2018-12-05 - Prototype implementation of LSP client - Visual Studio 2017.
* [sl3p](https://github.com/jklmnn/sl3p) ⭐ 1 | 🐛 0 | 🌐 Ada | 📅 2018-01-30 - Simple Layer 3 Protocol.
* [smart-pointers](https://github.com/alire-project/smart_pointers) ⭐ 1 | 🐛 1 | 🌐 Ada | 📅 2018-06-10 - A package providing a reference-counted access type Smart\_Pointer.
...
* [simple-blockchain](https://github.com/tomekw/simple_blockchain) ⭐ 24 | 🐛 0 | 🌐 Ada | 📅 2025-09-11 - Simple blockchain in Ada.
...
* [adagio](https://github.com/mosteo/adagio) ⭐ 4 | 🐛 0 | 🌐 Ada | 📅 2012-10-01 - Gnutella2 (G2) network server leaf.

[ada-language-server]: https://github.com/AdaCore/ada_language_server

### Cryptography

* [spark-nacl](https://github.com/rod-chapman/SPARKNaCl) ⭐ 137 | 🐛 4 | 🌐 Ada | 📅 2026-03-26 - SPARK 2014 re-implementation of the TweetNaCl crypto library.
...
* [libsodium-ada](https://github.com/jrmarino/libsodium-ada) ⭐ 12 | 🐛 1 | 🌐 Ada | 📅 2016-07-18 - A secure cryptographic library (libsodium for Ada).
* [spark-norx](https://github.com/jhumphry/SPARK_NORX) ⭐ 9 | 🐛 0 | 🌐 Ada | 📅 2018-06-19 - Ada/SPARK implementation of the NORX Authenticated Encryption with Additional Data Algorithm.
* [stotp](https://github.com/jklmnn/STOTP) ⭐ 9 | 🐛 0 | 🌐 Ada | 📅 2018-12-12 - Timed One-Time-Pad (RFC 6238) implementation in SPARK.
* [threefish](https://github.com/jrcarter/Threefish) ⭐ 6 | 🐛 0 | 🌐 Ada | 📅 2026-08-14 - Ada Implementation of the Threefish-256 Encryption Algorithm.
* [spark-sip-hash](https://github.com/jhumphry/SPARK_SipHash) ⭐ 6 | 🐛 0 | 🌐 Ada | 📅 2018-06-20 - Ada/SPARK implementation of the SipHash keyed hash function.
* [base58-ada](https://github.com/MichaelAllenHardeman/base58_ada) ⭐ 3 | 🐛 0 | 🌐 Ada | 📅 2017-10-06 - Base58 encoding and decoding in Ada.
* [ascon-spark](https://github.com/jhumphry/Ascon_SPARK) ⭐ 3 | 🐛 0 | 🌐 Ada | 📅 2023-02-11 - Ada/SPARK implementation of the Ascon Authenticated Encryption with Additional Data Algorithm.
* [ada-libsecret](https://github.com/stcarrez/ada-libsecret) ⭐ 2 | 🐛 0 | 🌐 Ada | 📅 2024-02-17 - Ada Binding for the libsecret library.
* [sip-hash](https://github.com/grim7reaper/SipHash) ⭐ 1 | 🐛 0 | 🌐 Ada | 📅 2014-02-15 - A pure Ada implementation of the SipHash PRF.
* [xxhash-ada](https://github.com/lyarbean/xxhash-ada) ⭐ 1 | 🐛 0 | 🌐 Ada | 📅 2022-10-05 - Extremely fast non-cryptographic Hash algorithm, xxhash is working at speeds close to RAM limits.
* [blake2s](https://github.com/lkujaw/blake2s) ⭐ 1 | 🐛 1 | 🌐 Ada | 📅 2021-10-12 - SPARK83 implementation of the BLAKE2s hash function.
* [fletcher](https://github.com/darkestkhan/fletcher) ⭐ 0 | 🐛 1 | 🌐 Ada | 📅 2019-03-03 - Trivial implementation of fletcher\_16 checksum computation algorithm.

### Compression

* [zip-ada](https://github.com/zertovitch/zip-ada) ⭐ 35 | 🐛 1 | 🌐 Ada | 📅 2026-08-01 - Programming library for dealing with the Zip compressed archive file format.
* [ada-lzma](https://github.com/stcarrez/ada-lzma) ⭐ 7 | 🐛 0 | 🌐 Ada | 📅 2025-11-29 - Ada binding for liblzma compression library.
* [dcf-ada](https://github.com/onox/dcf-ada) ⭐ 6 | 🐛 0 | 🌐 Ada | 📅 2022-07-31 - An Ada 2012 library for document container files (Based on [zip-ada]).

[zip-ada]: https://github.com/zertovitch/zip-ada

### Patterns

* [rxada](https://github.com/mosteo/rxada) ⭐ 24 | 🐛 8 | 🌐 Ada | 📅 2024-03-06 - An Ada 2012 implementation of the Rx methodology.
* [ada-promises](https://github.com/briot/Ada-promises) ⭐ 9 | 🐛 0 | 🌐 Ada | 📅 2017-03-10 - Implementing promises in Ada. Type-safe, efficient, thread-safe.
* [reqrep-task-pools](https://github.com/jhumphry/Reqrep_Task_Pools) ⭐ 2 | 🐛 0 | 🌐 Ada | 📅 2015-06-16 - Task pool system for jobs.

### System Modeling

* [radalib](https://github.com/sergio-gomez/Radalib) ⭐ 11 | 🐛 0 | 🌐 Ada | 📅 2023-11-16 - Ada library and tools for the analysis of Complex Networks and more.
* [ada-fuzzy](https://github.com/briot/adafuzzy) ⭐ 3 | 🐛 0 | 🌐 Ada | 📅 2016-01-12 - A fuzzy inference system library for Ada.

### Parsers, Scanners, Linters, Analysers, Interpreters and Prettyprinters

* [libadalang](https://github.com/AdaCore/libadalang/) ⭐ 169 | 🐛 21 | 🌐 Ada | 📅 2026-08-13 - Library for parsing and semantic analysis of Ada code. It is meant as a building block for integration into other tools (IDE, static analyzers, etc).
...
* [anagram](https://github.com/reznikmm/anagram) ⭐ 5 | 🐛 0 | 🌐 Ada | 📅 2021-02-14 - Grammar handling and parser generation Ada library.
* [ada-pretty](https://github.com/reznikmm/ada-pretty) ⭐ 5 | 🐛 0 | 🌐 Ada | 📅 2026-05-11 - Pretty printing library for Ada.
* [increment](https://github.com/reznikmm/increment) ⭐ 4 | 🐛 0 | 🌐 Ada | 📅 2020-11-28 - Incremental analysis in Ada.
* [xia](https://github.com/simonjwright/xia) ⭐ 4 | 🐛 0 | 🌐 Ada | 📅 2024-01-27 - An Ada implementation of XPath 1.0.
* [ada-lisp-embedded](https://github.com/BrentSeidel/Ada-Lisp-Embedded) ⭐ 4 | 🐛 0 | 🌐 Ada | 📅 2024-03-27 - Embeddable Lisp interpreter.
* [gela](https://github.com/reznikmm/gela) ⭐ 0 | 🐛 0 | 🌐 Ada | 📅 2021-03-13 - Ada code analyzer.
...
* [json-ada](https://github.com/onox/json-ada) ⭐ 47 | 🐛 4 | 🌐 Ada | 📅 2024-07-28 - An Ada 2012 library for parsing JSON.
* [protobuf](https://github.com/reznikmm/protobuf) ⭐ 45 | 🐛 13 | 🌐 Ada | 📅 2026-04-19 - A Google Protocol Buffers implementation in Ada, using [matreshka].
* [ada-toml](https://github.com/pmderodat/ada-toml) ⭐ 37 | 🐛 3 | 🌐 Ada | 📅 2026-08-14 - TOML parser for Ada.
* [xmlada](https://github.com/AdaCore/xmlada) ⭐ 30 | 🐛 9 | 🌐 Ada | 📅 2026-01-26 - The XML/Ada toolkit.
...
* [jwx](https://github.com/Componolit/jwx) ⚠️ Archived - A formally verified JSON library in SPARK.
...
* [excel-writer](https://github.com/zertovitch/excel-writer) ⭐ 9 | 🐛 2 | 🌐 Ada | 📅 2026-06-23 - Create Excel files with basic formats.
...
* [coap-spark](https://github.com/mgrojo/coap_spark) ⭐ 8 | 🐛 0 | 🌐 Ada | 📅 2026-02-22 - A formally verified implementation of CoAP, the Constrained Application Protocol.
...
* [axmpp](https://github.com/coopht/axmpp) ⭐ 9 | 🐛 4 | 🌐 Ada | 📅 2020-10-06 - With the AXMPP library you can connect to a Jabber server to send and receive messages.
* [weechat-ada](https://github.com/onox/weechat-ada) ⭐ 4 | 🐛 0 | 🌐 Ada | 📅 2022-08-01 - Ada 2012 library for WeeChat plug-ins.
* [weechat-emoji](https://github.com/onox/weechat-emoji) ⭐ 2 | 🐛 0 | 🌐 Ada | 📅 2022-08-16 - A WeeChat plug-in written in Ada 2012 that displays emoji.
* [weechat-canberra](https://github.com/onox/weechat-canberra) ⭐ 1 | 🐛 0 | 🌐 Ada | 📅 2022-08-16 - A WeeChat plug-in written in Ada 2012 that plays sounds using Canberra.

### Web

* [template-parser](https://github.com/AdaCore/templates-parser) ⭐ 9 | 🐛 2 | 🌐 Ada | 📅 2026-07-14 - AWS templates engine.
...
* [asfml](https://github.com/mgrojo/ASFML) ⭐ 43 | 🐛 2 | 🌐 Ada | 📅 2026-08-10 - Ada binding to the Simple and Fast Multimedia Library.
...
* [cuda](https://github.com/AdaCore/cuda) ⭐ 25 | 🐛 2 | 🌐 Ada | 📅 2024-09-10 - Support for CUDA (Compute Unified Device Architecture) from AdaCore.
...
* [ada-synthetizer](https://github.com/frett27/Ada-Synthetizer) ⭐ 20 | 🐛 1 | 🌐 Ada | 📅 2026-07-14 - Sound Synthetizer Library implemented in Ada.
* [ada-soundio](https://github.com/raph-amiard/ada-soundio) ⭐ 5 | 🐛 1 | 🌐 Ada | 📅 2016-01-27 - Ada bindings for libsoundio.
* [canberra-ada](https://github.com/onox/canberra-ada) ⭐ 4 | 🐛 0 | 🌐 Ada | 📅 2022-08-16 - Ada 2012 bindings for libcanberra, an implementation of the XDG Sound Theme and Name Specifications.
* [oto](https://github.com/darkestkhan/oto) ⭐ 3 | 🐛 2 | 🌐 Ada | 📅 2016-03-29 - Ada binding to OpenAL which tries to mimic original API while using Ada types.
* [coreland-openal-ada](https://github.com/io7m/coreland-openal-ada) ⚠️ Archived - Ada binding to OpenAL.
* [opus-ada](https://github.com/onox/opus-ada) ⭐ 2 | 🐛 0 | 🌐 Ada | 📅 2022-08-16 - Ada 2012 bindings for the Opus audio codec.
...
* [AdaTracker](https://github.com/UlrikHjort/Ada-Tracker) ⭐ 2 | 🐛 0 | 🌐 Ada | 📅 2026-04-14 - A MOD, XM, S3M, and IT music tracker player written in Ada, using SDL2 for audio output and UI rendering.
* [portable-openal-sound](https://github.com/fastrgv/portable-openal-sound) ⭐ 1 | 🐛 0 | 🌐 C | 📅 2024-10-14 - A linux-sound-playing package for Ada apps that can asynchronously start and stop music loops, as well as initiate transient sounds.
...
* [ux-strings](https://github.com/Blady-Com/UXStrings) ⭐ 18 | 🐛 0 | 🌐 Ada | 📅 2026-07-18 - Unicode extended strings.
...
* [simple-logging](https://github.com/alire-project/simple_logging) ⭐ 5 | 🐛 1 | 🌐 Ada | 📅 2026-02-28 - Easy to use logging facilities for output to console in Ada programs.
...
* [a-stream-tools](https://github.com/persan/a-stream-tools.git) ⭐ 4 | 🐛 0 | 🌐 Ada | 📅 2025-10-21 - Stream utilities for Ada2005 and 2012.
* [cstrings](https://github.com/mosteo/cstrings) ⭐ 2 | 🐛 0 | 🌐 Ada | 📅 2025-04-03 - Convenience subprograms to interact with C strings.
* [ssprep](https://github.com/persan/ssprep.git) ⭐ 1 | 🐛 0 | 🌐 Ada | 📅 2023-12-02 - An extensible template engine akin to jinja but using [template-parser] and intended for command line usage.
* [macos-sdks-vs-gcc](https://github.com/simonjwright/macos-sdks-vs-gcc) ⭐ 1 | 🐛 0 | 🌐 Ada | 📅 2021-03-04 - Provides GCC 'specs' files to cope with SDK policy changes.
* [licensing](https://github.com/mosteo/licensing) ⭐ 0 | 🐛 0 | 🌐 Ada | 📅 2018-02-25 - Open Source Licenses library for Ada.
* [rsfile](https://github.com/mosteo/rsfile) ⭐ 0 | 🐛 1 | 🌐 Ada | 📅 2022-08-01 - Command-line utility that picks a file from a folder hierarchy with probability proportional to its size.
* [cvsweb2git](https://github.com/reznikmm/cvsweb2git) ⭐ 0 | 🐛 0 | 🌐 Ada | 📅 2023-11-11 - Tool to imports CVS repository shared on Ada Conformity Assessment Authority into the Git repository.
* [getopt-ada](https://git.sr.ht/~nytpu/getopt-ada) - Portable implementation of getopt(3) in Ada.

### Robotics

* [rclada](https://github.com/ada-ros/rclada) ⭐ 11 | 🐛 4 | 🌐 Ada | 📅 2024-09-19 - Ada client library for ROS2/RCL.
* [player-ada](https://github.com/mosteo/player-ada) ⭐ 4 | 🐛 0 | 🌐 Ada | 📅 2014-06-09 - Ada bindings for the player robotic platform.

### Linux and POSIX

* [florist](https://github.com/AdaCore/florist/) ⭐ 9 | 🐛 9 | 🌐 Ada | 📅 2026-06-11 - POSIX Ada binding, IEEE Standards 1003.5(b,c).
...
* [wposix](https://github.com/AdaCore/wposix) ⭐ 4 | 🐛 0 | 🌐 Ada | 📅 2026-06-11 - Ada Windows POSIX binding.
...
* [win32ada](https://github.com/AdaCore/win32ada) ⭐ 22 | 🐛 2 | 🌐 Ada | 📅 2026-03-26 - Ada API to the Windows library.
...
* [ada-lua](https://github.com/AdaCore/ada-lua) ⭐ 46 | 🐛 0 | 🌐 Ada | 📅 2023-12-11 - Ada binding for Lua.
* [tcl-ada-shell](https://github.com/simonjwright/tcladashell) ⭐ 12 | 🐛 2 | 🌐 Ada | 📅 2023-02-26 - Tcl Ada SHell (Tash) is an Ada binding to Tcl/Tk.
* [tashy](https://github.com/thindil/tashy) ⚠️ Archived - Tcl Ada SHell Younger (Tashy) is derivate of Tash, focused mostly on Tk binding.
* [coreland-lua-ada](https://github.com/io7m/coreland-lua-ada) ⚠️ Archived - Ada bindings to the Lua language.
* [tashy2](https://github.com/thindil/tashy2) ⚠️ Archived - Derivate of Tashy that aims to be more idiomatic and uses a more permisive license.

## Hardware and Embedded

### Frameworks

* [SweetAda](https://github.com/gabriele-galeotti/SweetAda) ⭐ 53 | 🐛 0 | 🌐 Ada | 📅 2026-08-11 - A lightweight development framework whose purpose is the implementation of Ada-based software systems. It supports a plethora or CPU architectures and development boards.
* [adamant](https://github.com/lasp/adamant) ⭐ 49 | 🐛 6 | 🌐 Ada | 📅 2026-08-11 - A component-based, model-driven framework for constructing reliable and reusable real-time software.
* [libgfxinit](https://github.com/coreboot/libgfxinit) ⭐ 26 | 🐛 0 | 🌐 Ada | 📅 2026-07-30 - A graphics initialization (aka modesetting) library for embedded environments, implemented in SPARK.
* [robotics-with-ada](https://github.com/AdaCore/Robotics_with_Ada) ⚠️ Archived - Robotics with Ada, ARM, and Lego.

### Firmwares

* [certiflie](https://github.com/AdaCore/Certyflie) ⚠️ Archived - Source code for the full Ada + SPARK Crazyflie 2.0 firmware.

### Drivers

* [ada-drivers-library](https://github.com/AdaCore/Ada_Drivers_Library) ⭐ 283 | 🐛 24 | 🌐 Ada | 📅 2026-07-08 - Ada drivers for various MCU and sensors.
* [dw1000](https://github.com/damaki/DW1000) ⭐ 14 | 🐛 1 | 🌐 Ada | 📅 2019-09-25 - Ada/SPARK driver for the DecaWave DW1000 ultra-wideband (UWB) radio chip.
* [em-brick](https://github.com/it-cosmos/emBRICK) ⭐ 0 | 🐛 0 | 🌐 Ada | 📅 2016-04-25 - emBRICK driver and support for emBRICK in Ada.
* [evb1000](https://github.com/damaki/EVB1000) ⭐ 0 | 🐛 0 | 🌐 C | 📅 2017-05-08 - Ada/SPARK drivers to control the on-board peripherals of the DecaWave EVB1000 evaluation board.
* [multiplexed-io](https://github.com/simonjwright/multiplexed-io) ⭐ 0 | 🐛 0 | 🌐 Ada | 📅 2016-10-18 - This contains explorations, for AdaPilot, of implementing drivers for the AdaRacer MCU, using the Ravenscar profile of Ada 2012 from AdaCore and device bindings generated using SVD2Ada.

### Controllers

* [solenoid-engine-controller](https://github.com/Fabien-Chouteau/solenoid-engine-controller) ⭐ 5 | 🐛 1 | 🌐 Ada | 📅 2015-11-21 - Software controller for solenoid engines (Ada/STM32F4).

### Communication

* [ada-enet](https://github.com/stcarrez/ada-enet) ⭐ 26 | 🐛 4 | 🌐 Ada | 📅 2026-07-14 - Embedded network stack (Ethernet driver, IPv4, UDP, DNS, DHCP, NTP) for STM32F746 or STM32F769.
* [sensortile](https://github.com/morbos/STM32/tree/master/L/L476/sensortile) ⭐ 20 | 🐛 0 | 🌐 Ada | 📅 2024-04-07 - This project shows how to initialize a SensorTile and how to send sensor data over BLE from a SensorTile to a suitable host.

### Libraries

* [ada-synth-lib](https://github.com/raph-amiard/ada-synth-lib) ⭐ 36 | 🐛 7 | 🌐 Ada | 📅 2020-05-31 - Simple audio synthesis library that can run on bareboard devices.
* [geste](https://github.com/Fabien-Chouteau/GESTE) ⭐ 20 | 🐛 0 | 🌐 Ada | 📅 2020-01-29 - Sprite and tile 2D render engine designed to run on micro-controllers.
* [ada-time](https://github.com/Fabien-Chouteau/Ada_Time) ⭐ 18 | 🐛 0 | 🌐 Ada | 📅 2015-11-12 - Ada binding for the Pebble Time smartwatch.
* [giza](https://github.com/Fabien-Chouteau/Giza) ⭐ 8 | 🐛 0 | 🌐 Ada | 📅 2017-04-22 - This library is trying to be a simple widget tool kit for embedded platforms.
* [stm32-ui](https://github.com/stcarrez/stm32-ui) ⭐ 5 | 🐛 0 | 🌐 Ada | 📅 2018-12-02 - STM32 UI library and tools (graphs, images, 12 hour clock).
* [sancta](https://github.com/mosteo/sancta) ⭐ 1 | 🐛 0 | 🌐 Ada | 📅 2014-06-10 - Multi-robot task allocation library.
* [wiring-pi-ada](https://github.com/jklmnn/wiringPi-Ada) ⭐ 0 | 🐛 0 | 🌐 Ada | 📅 2018-09-01 - Ada bindings for wiringPi.

### Applications

* [wee-noise-maker](https://github.com/Fabien-Chouteau/Wee-Noise-Maker) ⚠️ Archived - Wee Noise Maker is an open source pocket synthesizer.
* [etherscope](https://github.com/stcarrez/etherscope) ⭐ 19 | 🐛 0 | 🌐 Ada | 📅 2017-12-03 - Ethernet traffic monitor on a STM32F746 board.
* [noise-nugget](https://github.com/Fabien-Chouteau/noise-nugget) ⭐ 17 | 🐛 0 | 🌐 Ada | 📅 2018-10-21 - Square Inch Synthesizer.
* [coffee-clock](https://github.com/Fabien-Chouteau/coffee-clock) ⭐ 7 | 🐛 0 | 🌐 Ada | 📅 2017-05-16 - Waking up with a fresh cup of coffee.
* [spark-railway-demo](https://github.com/Fabien-Chouteau/spark-railway-demo) ⭐ 7 | 🐛 0 | 🌐 Ada | 📅 2016-11-02 - Simulated railway network in SPARK/Ada.
* [railway-simulation](https://github.com/AdaCore/SPARK_Railway_Simulation_Demo) ⚠️ Archived - Program simulating a railway network with trains, switches and signaling. The signaling system is proven with SPARK/Ada to ensure that trains cannot collide.
* [micro-tem-pi](https://github.com/jklmnn/MicroTemPi) ⭐ 2 | 🐛 0 | 🌐 Ada | 📅 2018-09-05 - Raspberry Pi using a BBC Micro:Bit as temperature sensor.
* [lunar-lander-rotation](https://github.com/AdaCore/Lunar_Lander_Rotation_Demo) ⚠️ Archived - Program that interacts with the AdaFruit BNO055 breakout board in order to send orientation data to a host computer.

### Generators

* [svd2ada](https://github.com/AdaCore/svd2ada) ⭐ 71 | 🐛 22 | 🌐 Ada | 📅 2026-07-17 - An Ada binding generator from SVD descriptions for bare board ARM devices.
...
* [yass](https://github.com/yet-another-static-site-generator/yass) ⭐ 27 | 🐛 4 | 🌐 Ada | 📅 2025-09-05 - Yet Another Static Site Generator (like Jekyll or Hugo).
* [wasabee](https://github.com/zertovitch/wasabee) ⭐ 14 | 🐛 0 | 🌐 Ada | 📅 2026-01-17 - A Web browser with safety focus.
* [ironsides](https://ironsides.martincarlisle.com) - Authoritative DNS server verified by SPARK/Ada.

### Multimedia

* [ada-3ds](https://github.com/AdaDoom3/Ada3DS) ⭐ 4 | 🐛 0 | 🌐 Ada | 📅 2015-01-05 - A simple 3DS Max model renderer.
* [blackvideo-mini-player](https://github.com/BlackBlazent/blackvideo-mini-player) ⭐ 4 | 🐛 12 | 🌐 Ada | 📅 2026-03-20 - A stand-alone lightweight auxiliary video player support for [`BlackVideo`](https://github.com/BlackBlazent/BlackVideo) ⭐ 4 | 🐛 8 | 🌐 TypeScript | 📅 2026-04-04.
...
* [ghdl](https://github.com/ghdl/ghdl) ⭐ 2,860 | 🐛 371 | 🌐 VHDL | 📅 2026-08-13 - VHDL 2008/93/87 simulator.
...
* [parallel-sim](https://github.com/JulianSchutsch/ParallelSim) ⭐ 2 | 🐛 0 | 🌐 Ada | 📅 2013-06-15 - Distributed Simulation of Transport Networks.
...
* [pascal-to-ada](https://github.com/zertovitch/pascal-to-ada) ⭐ 18 | 🐛 0 | 🌐 Ada | 📅 2024-10-20 - A Pascal to Ada translator.
  * [tp7-ada-gnoga](https://github.com/Blady-Com/tp7ada-gnoga) ⭐ 5 | 🐛 0 | 🌐 Ada | 📅 2026-05-13 - Implementation of Turbo Pascal 7.0 units with [gnoga].
  * [tp7-ada-gtkada](https://github.com/Blady-Com/tp7ada-gtkada) ⭐ 3 | 🐛 0 | 🌐 Ada | 📅 2021-07-31 - Implementation of Turbo Pascal 7.0 units with [gtkada].
* [cappulada](https://github.com/Componolit/Cappulada) ⚠️ Archived - Ada binding generator for C++.
...
* [gsh](https://github.com/AdaCore/gsh) ⭐ 117 | 🐛 12 | 🌐 C | 📅 2023-07-22 - Non interactive POSIX shell for Windows, aimed at GNU software builds. 2-3 times faster than Cygwin.
* [dashera](https://github.com/SMerrony/dashera) ⚠️ Archived - Data General DASHER terminal emulator using [gtkada].
* [a-shell](https://github.com/charlie5/aShell) ⭐ 18 | 🐛 1 | 🌐 Ada | 📅 2025-11-04 - A component to aid in writing shell-like applications in Ada.
* [analytical-engine](https://github.com/simonjwright/analytical-engine) ⭐ 15 | 🐛 2 | 🌐 Ada | 📅 2022-05-13 - An Ada 2012 emulation of Charles Babbage's Analytical Engine.
* [yotroc](https://github.com/docandrew/YOTROC) ⭐ 5 | 🐛 0 | 🌐 Ada | 📅 2020-01-06 - Assembler/Emulator for a fictional CPU architecture. IDE implemented in [gtkada].
...
* [whitakers-words](https://github.com/mk270/whitakers-words) ⭐ 328 | 🐛 52 | 🌐 Ada | 📅 2026-08-13 - William Whitaker's WORDS, a Latin dictionary.
