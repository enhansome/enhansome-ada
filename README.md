...
<img width="120px" hspace="10px" src="https://docs.adacore.com/live/wave/gps/html/gps_ug/_images/gps-main-window.png"/> [The GNAT Programming Studio](https://github.com/AdaCore/gps) ⭐ 527 | 🐛 58 | 🌐 Ada | 📅 2026-08-28
...
* [alire](https://github.com/alire-project/alire) ⭐ 405 | 🐛 364 | 🌐 Ada | 📅 2026-08-28 - A catalog of ready-to-use Ada libraries plus a command-line tool (alr) to obtain, compile, and incorporate them into your own projects. It aims to fulfill a similar role to Rust's cargo or OCaml's opam.
...
* [bb-runtimes](https://github.com/AdaCore/bb-runtimes) ⭐ 72 | 🐛 6 | 🌐 Ada | 📅 2026-08-18 - GNAT bare metal board support package (BSP).
...
* [Straylight](https://github.com/ajxs/straylight) ⭐ 3 | 🐛 0 | 🌐 Ada | 📅 2026-08-30 - A simple monolithic RISC-V operating system developed in Ada.
...
* [eepers](https://github.com/tsoding/eepers) ⭐ 474 | 🐛 5 | 🌐 Ada | 📅 2024-05-26 - A simple Turn-based Game in Ada (made with [raylib](https://github.com/raysan5/raylib) ⭐ 34,530 | 🐛 16 | 🌐 C | 📅 2026-08-29).
* [steamsky](https://github.com/thindil/steamsky) ⭐ 104 | 🐛 1 | 🌐 Nim | 📅 2026-08-30 - Roguelike in sky with a steampunk setting.
...
* [civ-klon](https://github.com/HonkiTonk/Civ-Klon) ⭐ 23 | 🐛 1 | 🌐 Ada | 📅 2026-08-30 - Civilization-style turn-based strategy game. Requires [asfml].
...
* [lace](https://github.com/charlie5/lace) ⭐ 13 | 🐛 1 | 🌐 Ada | 📅 2026-08-29 - A set of Ada components to allow 3D simulations, games and GUI's in Ada.
...
* [gtkada](https://github.com/AdaCore/gtkada) ⭐ 109 | 🐛 33 | 🌐 Ada | 📅 2026-08-28 - Ada graphical toolkit based on Gtk3 components.
...
* [awa](https://github.com/stcarrez/ada-awa) ⭐ 113 | 🐛 13 | 🌐 Ada | 📅 2026-08-09 - Ada Web Application is a framework to build a Web Application in Ada 2012. The framework provides several ready to use and extendable modules that are common to many web application. This includes the login, authentication, users, permissions, managing comments, tags, votes, documents, images.
  ...
  * [dynamo](https://github.com/stcarrez/dynamo) ⭐ 19 | 🐛 5 | 🌐 Ada | 📅 2026-04-04 - Code generator used to generate an Ada Web Application or database mappings from hibernate-like XML description, YAML doctrine model or UML models.
...
* [bbt](https://github.com/LionelDraghi/bbt) ⭐ 29 | 🐛 4 | 🌐 Ada | 📅 2026-07-24 - Simple tool to black box check the behavior of an executable through the command line.
...
* [ada-language-server](https://github.com/AdaCore/ada_language_server) ⭐ 303 | 🐛 31 | 🌐 Ada | 📅 2026-08-28 - Adacore server implemention of the the Microsoft Language Protocol for Ada and SPARK.
...
* [libadalang](https://github.com/AdaCore/libadalang/) ⭐ 170 | 🐛 21 | 🌐 Ada | 📅 2026-08-28 - Library for parsing and semantic analysis of Ada code. It is meant as a building block for integration into other tools (IDE, static analyzers, etc).
...
* [zeromq-ada](https://github.com/persan/zeromq-Ada.git) ⭐ 42 | 🐛 1 | 🌐 Ada | 📅 2026-07-17 - Binding to the ZeroMQ comunications-library.
...
* [adamant](https://github.com/lasp/adamant) ⭐ 50 | 🐛 7 | 🌐 Ada | 📅 2026-08-30 - A component-based, model-driven framework for constructing reliable and reusable real-time software.
...
* [ghdl](https://github.com/ghdl/ghdl) ⭐ 2,871 | 🐛 343 | 🌐 VHDL | 📅 2026-08-29 - VHDL 2008/93/87 simulator.
...
* [whitakers-words](https://github.com/mk270/whitakers-words) ⭐ 331 | 🐛 50 | 🌐 Ada | 📅 2026-08-26 - William Whitaker's WORDS, a Latin dictionary.
